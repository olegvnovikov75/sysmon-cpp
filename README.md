...
```
┌─ sysmon — userver────────────────────────────────────────────────────────────────────────────────┐
│ 20.08.2026 10:52:13   up 0d 01h 42m   refresh 1s                                                 │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ CPU — Intel(R) Xeon(R) CPU E5-2678 v3 @ 2.50GHz─────────────────────────────────────────────────┐
│   0%   [░░░░░░░░░░░░░░░░░░░░░░░░]  load 0.96 1.00 0.96   24 cores                                │
│  49°C   [████████████░░░░░░░░░░░░]                                                               │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ RAM─────────────────────────────────────────────────────────────────────────────────────────────┐
│  64%   [███████████████░░░░░░░░░]    19.9 /   31.2 GiB  swap 0.00 / 8.00 GiB                     │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ GPU 0 — NVIDIA CMP 170HX────────────────────────────────────────────────────────────────────────┐
│   0%   [░░░░░░░░░░░░░░░░░░░░░░░░]  vram  42.5/ 64.0 GiB ( 66%)  1140 MHz  44 W                   │
│  51°C   [████████████░░░░░░░░░░░░]                                                               │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ GPU 1 — NVIDIA GeForce RTX 3050─────────────────────────────────────────────────────────────────┐
│   0%   [░░░░░░░░░░░░░░░░░░░░░░░░]  vram   0.4/  8.0 GiB (  5%)  210 MHz                          │
│  42°C   [██████████░░░░░░░░░░░░░░]                                                               │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ LLM : 1234 — qwen38-27b-uncensored──────────────────────────────────────────────────────────────┐
│ ctx          56%  [█████████████░░░░░░░░░░░]  147k/262k tok                                      │
│ cache reuse  98%  [███████████████████████░]                                                     │
│ spec accept  79%  [███████████████████░░░░░]                                                     │
│ gen 0.0 t/s   prefill 0.0 t/s   busy 1   reqs 0                                                  │
├──────────────────────────────────────────────────────────────────────────────────────────────────┤
┌─ Network─────────────────────────────────────────────────────────────────────────────────────────┐
...
│ sdd      HDD   465.8 GiB  WDC WD5000AAKX-0                                                       │
...
| **LLM** (все llama-server) | порт, модель, ctx % (бар, занято/лимит tok), cache reuse % (бар), spec accept % (бар), gen tok/s, prefill tok/s, busy slots, requests | `/proc/*/cmdline` + один GET `/metrics` на сервер |
| **Network** | rx/tx MB/s по каждому активному интерфейсу | `/sys/class/net/*/statistics` (дельты) |
| **Disks** | целые диски: тип (HDD/SSD/NVMe), размер GiB, модель | `/sys/block/*` (size, queue/rotational, device/model), `/sys/class/nvme/*/model` |
...
пустые ячейки — видимый серый трек. Дата в формате `дд.мм.гггг`.
